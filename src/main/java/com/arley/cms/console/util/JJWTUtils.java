...
public class JJWTUtils {
    ...
    public static SecretKey generalKey(){
        //本地的密码解码[B@152f6e2
        byte[] encodedKey = Base64.decodeBase64(key_prefix + PublicConstants.TOKEN_KEY);
    ...
    public static void main(String[] args) {
        ...
        data.put("name", "2323ss2");
        String abc = createJWT(JSON.toJSONString(data), -1);
        System.out.println(abc);*/

        Claims abc1 = parseJWT("eyJhbGciOiJIUzI1NiJ9.eyJqdGkiOiJkMzE4M2JlNC03YzE2LTRkMzQtYWU3Mi1kNmE5YjU3MjBjMjEiLCJpYXQiOjE1NDExNDI2MDYsInN1YiI6IntcIm5hbWVcIjpcIkFybGV5XCIsXCJ1c2VySWRcIjoxLFwidXNlck5hbWVcIjpcImFkbWluXCJ9In0.w-RRiyqYQr1cW1UCzaEb6NaiBXloswSmsNhXzW2FUUc");
