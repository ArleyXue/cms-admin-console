...
import com.arley.cms.console.shiro.CustomCacheManager;
import com.arley.cms.console.shiro.JwtFilter;
import com.arley.cms.console.shiro.MyShiroRealm;
...
public class ShiroConfiguration {
    ...
    public DefaultWebSecurityManager getManager(RedisDao redisDao) {
        ...
        // 设置自定义Cache缓存
        manager.setCacheManager(new CustomCacheManager(redisDao));
        return manager;
    }
